...
class Vgg16():
    def __init__(self, vgg16_path=None):
        if vgg16_path is None:
            ...
            # 导入vgg6模型的参数
            # data_dict的键是每一层网络的名称，值是每一层网络的参数
            # data_dict.keys()输出为
            # dict_keys(['conv5_1', 'fc6', 'conv5_3',
            # 'conv5_2', 'fc8', 'fc7', 'conv4_1', 'conv4_2',
            # 'conv4_3', 'conv3_3', 'conv3_2', 'conv3_1',
    ...
    def forward(self, images):
        ...
        # 按照vgg6论文的论述，将每一个像素都乘以255
        rgb_scaled = images * 255.0
        # 将rgb图片按照3个维度（r，g，b通道）切分为3份
        red, green, blue = tf.split(
            rgb_scaled, cnn_vgg6_utils.RGB_CHANNEL, cnn_vgg6_utils.RGB_CHANNEL)
        # 每个样本减去该颜色通道的平均值，并转换为bgr格式的新数据
        bgr = tf.concat([
            blue - VGG_MEAN[0],
            green - VGG_MEAN[1],
            red - VGG_MEAN[2]], 3)
